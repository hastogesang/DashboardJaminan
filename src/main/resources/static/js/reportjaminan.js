        ...
        <form>
            <div class="row">
              <div class="form-group form-row col-md-6">
                ...
                <div class="col-sm-8">
                  <select id="namaReport" class="form-control form-select-sm">
            ...
            <div class="form-group form-row col-md-6">
                ...
                <div class="col-sm-8">
                <select id="anggotaKeliring" class="form-control form-select-sm">
            ...
            <div class="row">
              <div class="form-group form-row col-md-6">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" id="tanggalAwal" placeholder="dd/mm/yy" required>
                </div>
              </div>
              <div class="form-group form-row col-md-4">
                <label for="tanggalAkhir" class="col-sm-4 col-form-label">Sampai Dengan</label>
                <div class="col-sm-8">
                  <input type="text" class="form-control" id="tanggalAkhir" placeholder="dd/mm/yy" required>
                </div>
              </div>
            </div>
